...
public class CourseOffer {
    ...
    public void printOfferInformation(){
        String facultyName = "No teacher assigned";
        if (facultyName != null){
            facultyName = facultyassignment.getTeacherName();
        }
        System.out.println(" - " + course.getCOurseNumber() + " - " + course.getName() + " - " + facultyName + " - " + getNumberOfEmptySeat() +" available out of " + seatlist.size() + " total seats");
    }
